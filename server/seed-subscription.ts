...
async function createSubscriptionProduct() {
  ...
  const product = await stripe.products.create({
    ...
    description: 'Full access to 365 days of professional hair extension content ideas, AI caption generation, personalized hashtags, and special day reminders',
    metadata: {
      type: 'subscription',
