      ...
      <div className="min-h-screen bg-background pb-24">
        <header className="sticky top-0 z-50 glass-header">
          <div className="max-w-lg mx-auto px-4 py-3 flex items-center gap-3">
            ...
            <h1 className="font-heading font-semibold text-lg">Post Not Found</h1>
          </div>
        </header>
      ...
      <header className="sticky top-0 z-50 glass-header">
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-heading font-semibold text-lg">{months[post.month - 1]} {post.day}</h1>
              <p className="text-xs text-muted-foreground">{format(postDate, "EEEE")}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1 flex-wrap">
                <Badge
                  variant="secondary"
                  className={`${categoryColors[post.category as Category]} border-0 gap-1 text-xs`}
                >
